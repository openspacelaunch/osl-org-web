...
export function TrusteesSectionComponent() {
  const trustees = [
    ...
    },
    {
      ...
      image: "/alistair-john-profile-pic.jpg",
      intro:
    ...
    {
      name: "James Eddy",
      image: "/james-eddy-profile-pic.jpg",
      intro:
    ...
    {
      name: "Malcolm Pinto",
      image: "/malcom-pinto-profile-pic.jpg",
      intro:
    ...
    {
      name: "Adriel Tey",
      image: "/adriel-tey-profile-pic.jpg",
      intro:
    ...
    },
    {
      ...
      image: "/john-doe-profile-pic.png",
      intro:
          ...
          {trustees.map((trustee) => (
            ...
            >
              <div className="w-48 h-48 rounded-full overflow-hidden mb-6">
                <Image
                  src={trustee.image || "/john-doe-profile-pic.png"}
                  alt={trustee.name}
